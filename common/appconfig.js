...
export default {
	...
	async updataConfig(data){
		...
		uni.setStorageSync('campus',data.campus)
		uni.setStorageSync('campus1',data.campus_1)
		uni.setStorageSync('campus2',data.campus_2)
		uni.setStorageSync('campus3',data.campus_3)
