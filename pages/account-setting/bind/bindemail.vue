<template>
	<view class="body">
		...
		<view class="step1body" :class="step1" v-if="!step1verified">
			...
			<view class="user-email u-f-jsb">
				...
				<view class="getcode-button u-f-ajc" >
					<view @tap="getCheckNum1" hover-class="gcode-hover" hover-stay-time="100">{{!codetime?'获取验证码':codetime+' s'}}</view>
				</view>
			</view>
		...
		<view class="step2body" :class="step2">
			<view class="step_title" v-show="step1verified">
				<view>{{old_email?'现在开始验证您的新邮箱':'绑定邮箱'}}</view>
				<navigator url="../../user-login/login-help/login-help">收不到验证码？</navigator>
			</view>
