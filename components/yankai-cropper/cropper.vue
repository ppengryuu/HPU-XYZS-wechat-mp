<template>
	<view class="cropper" id="cropper">
		...
		<view class="cropper-body">
			...
			<view :style="{ width: stageWidth + 'px', height: stageHeight + 'px', left: stageLeft + 'px', top: stageTop + 'px' }" class="cropper-stage" @touchstart="touchStart" @touchmove="touchMove">
				...
				wx.canvasToTempFilePath(
					{
						...
						success: res => {
							this.$emit('complete', { param, path: res.tempFilePath });
						}
					},
					this
				);
